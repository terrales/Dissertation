...
class Config(object):
    ...
    def model_specific_dir(self, root):
        ...
        directory = {
            ...
            'ac-aveni-latent' : 'Ac-AVENI-DYLE', 
            'comm-aveni-latent' : 'Comm-AVENI-DYLE', 
            'prod-aveni-latent' : 'Prod-AVENI-DYLE', 
            'all-aveni-latent' : 'AllQMSum-AVENI-DYLE',
            'product-latent' : 'Product-DYLE',
            'ac-prod-latent' : 'Ac-Prod-DYLE',
            'comm-prod-latent' : 'Comm-Prod-DYLE'}[self.target_task]
